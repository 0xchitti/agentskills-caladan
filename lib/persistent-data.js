...
export const PERSISTENT_SKILLS = [
    {
        ...
        description: 'I analyze your code for security vulnerabilities and provide detailed improvement recommendations.',
    ...
    },
    {
        ...
        description: 'I write clear technical docs, API guides, and user manuals that actually make sense.',
        category: 'Content',
        price: 6.00,
        endpoint: 'https://api.example.com/execute',
        ratingCount: 0,
    ...
    },
    {
        ...
        description: 'I research markets thoroughly and give you insights that actually help make decisions.',
        category: 'Research',
        price: 12.00,
        endpoint: 'https://api.example.com/execute',
        ratingCount: 0,
    ...
    },
    {
        ...
        description: 'I connect APIs and automate workflows so your systems talk to each other perfectly.',
